      ...
      <div className="sticky top-0 bg-white border-b z-10 p-6">
        <div className="flex items-start justify-between">
          <div className="flex-1">
            ...
            <div className="flex flex-wrap gap-2 text-sm text-gray-600">
              ...
              <span className="px-3 py-1 bg-gray-100 rounded-full">{job.locationType}</span>
              {job.experienceLevel && job.experienceLevel !== 'Not specified' && (
                <span className="px-3 py-1 bg-gray-100 rounded-full">{job.experienceLevel}</span>
              )}
              <span className="text-gray-500">{job.postedDisplay}</span>
            </div>
          </div>
        ...
        <div className="flex gap-3 mt-4">
          <a
            ...
            className="flex-1 bg-blue-600 text-white px-6 py-2 rounded-lg font-semibold hover:bg-blue-700 transition-colors text-center"
          >
            Apply Now
          </a>
          <button
      ...
      <div className="p-6">
        ...
        <div className="mb-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
          <div className="flex items-center justify-between mb-3">
            <h2 className="text-lg font-semibold text-gray-900">Your Skills Match</h2>
            <button
              onClick={() => onSkillsInsightClick(job)}
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div>
              <p className="text-gray-600 mb-1">Skills to Learn</p>
