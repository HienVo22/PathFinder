      ...
      <div className="w-full max-w-md mx-auto px-4">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
          ...
          <div className="flex mb-6">
            ...
            <button onClick={() => setIsLogin(false)} className={`flex-1 py-2 px-4 rounded-lg font-medium transition-colors ${!isLogin ? 'bg-primary-600 text-white' : 'text-secondary-600 hover:text-primary-600'}`}>Sign Up</button>
          </div>
